...
Plan so I can just start slotting things in (while data processes).
- each student should present the highlights of their project (5-8 minutes, with 3-5 minutes for questions). This should cover the 5 areas outlined in the proposal, but does not need to go as deep or be as complete as the final report.

5 areas:

1) your research question 2) dataset (or datasets) you plan to use 3) expected data processing steps after data acquisition 4) planned analysis techniques and 5) key expected components of the final deliverable
...
The toughest by far is calculating street widths. This involves
