...
- [x] more raster join (2pm-3pm)
    - [x] finish the elevation grading
        - [x] handle case by case suspicious - see if you can try to group them and detect others
    - [x] get tree cover
        - [x] have inital
        - [x] but some 1.0s and need to check the data

- Build analytical table (3:45-4:45)
    - [x] clean
    - [x] everything to crash data
    - [x] I'm sure tons to fill in gap and clean

- Analysis and Mapping (4:45 - 7)
